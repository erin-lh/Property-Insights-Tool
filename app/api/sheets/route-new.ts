...
async function createJWT(): Promise<string> {
  ...
  if (!serviceAccountEmail || !serviceAccountKey) {
    throw new Error(
      "Google Service Account credentials not configured. Please set GOOGLE_SERVICE_ACCOUNT_EMAIL and GOOGLE_SERVICE_ACCOUNT_PRIVATE_KEY environment variables.",
    )
  }
