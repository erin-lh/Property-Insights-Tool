                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      <Badge className={`text-xs ${getConditionColor(room.condition)}`}>{room.condition}</Badge>
                    </div>
                  </div>
                </div>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-gray-700">{room.temperature}</span>
                </div>
                <div className="flex items-center gap-2">
                  <Droplets className="h-4 w-4 text-blue-500" />
                  <span className="text-sm text-gray-700">{room.humidity}</span>
                </div>
              </div>
